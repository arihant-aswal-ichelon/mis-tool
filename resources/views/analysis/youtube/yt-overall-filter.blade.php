...
<form method="post" class="row" action="">
    ...
    <div class="col-sm-4">
        ...
        <select class="form-select mb-3" name="record" aria-label="record">
            ...
            <option value="40" <?php if(isset($data['maxresults']) && $data['maxresults'] == 40){echo "selected"; }?>>40</option>
            <option value="50" <?php if(isset($data['maxresults']) && $data['maxresults'] == 50){echo "selected"; }?>>50</option>
        </select>
    </div>
    <div class="col-sm-5">
