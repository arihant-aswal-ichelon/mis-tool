...
<div class="col-sm-12 mb-15">
    ...
    <a class="btn btn-primary <?php if($section == "programming"){echo 'section-active';}?>" href="<?php echo url('/present-client/instagram-insights/'.$instagramAccountId.'/'.$client_id.'/?fields='.base64_encode(json_encode(array('section' => "programming", 'from_section' => isset($data['from_section'])?$data['from_section']:"")))); ?>">Programming</a>
</div>
