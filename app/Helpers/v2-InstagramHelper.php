        ...
        try {
            $response = Http::withHeaders([
                ...
                'messages' => [
                    ...
                    [
                        'role' => 'user',
                        'content' => "Classify this content: \"{$caption}\"\n\nCategory definitions:\n- informational: provides detailed information about concerns, utility, technology, or services\n- results/case study: talks in detail about service outcomes or treatment impact on patients/clients\n- branding: talks about unique aspects of the brand\n- moment marketing: focuses on trending content or situational information\n- topical: celebration/festive days or awareness topics\n- patient testimonial: refers to success stories or outcomes achieved by patients/clients\n\nReturn only the category name:"
                    ]
                ],
                'max_tokens' => 20,
                'temperature' => 0.1,
