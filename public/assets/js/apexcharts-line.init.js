...
linechartannotationsColors &&
    ((options = {
        ...
        chart: { height: 350, type: "line", id: "areachart-2", toolbar: { show: !1 } },
        annotations: {
            yaxis: [
                { y: 8200, borderColor: "#038edc", label: { borderColor: "#038edc", style: { color: "#fff", background: "#038edc" }, text: "Support" } },
                { y: 8600, y2: 9e3, borderColor: "#f7cc53", fillColor: "#f7cc53", opacity: 0.2, label: { borderColor: "#f7cc53", style: { fontSize: "10px", color: "#000", background: "#f7cc53" }, text: "Y-axis range" } },
            ],
            xaxis: [
                { x: new Date("23 Nov 2017").getTime(), strokeDashArray: 0, borderColor: "#564ab1", label: { borderColor: "#564ab1", style: { color: "#fff", background: "#564ab1" }, text: "Anno Test" } },
                {
                    x: new Date("26 Nov 2017").getTime(),
                    x2: new Date("28 Nov 2017").getTime(),
                    fillColor: "#51d28c",
                    opacity: 0.4,
                    label: { borderColor: "#000", style: { fontSize: "10px", color: "#fff", background: "#000" }, offsetY: -10, text: "X-axis range" },
                },
            ],
            points: [
                {
                    ...
                    label: { borderColor: "#f34e4e", offsetY: 0, style: { color: "#fff", background: "#f34e4e" }, text: "Point Annotation" },
                },
                { x: new Date("08 Dec 2017").getTime(), y: 9340.85, marker: { size: 0 }, image: { path: "./assets/images/logo-sm.png", width: 40, height: 40 } },
            ],
        },
        dataLabels: { enabled: !1 },
        stroke: { curve: "straight" },
        ...
        title: { text: "Line with Annotations", align: "left", style: { fontWeight: 500 } },
        labels: series.monthDataSeries1.dates,
        xaxis: { type: "datetime" },
    }),
    (chart = new ApexCharts(document.querySelector("#line_chart_annotations"), options)).render());
var chart,
    data = generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 185, { min: 30, max: 90 }),
    brushchartLine2Colors = getChartColorsArray("brushchart_line2"),
    brushchartLineColors =
        (brushchartLine2Colors &&
            ((options = {
                series: [{ data: data }],
                chart: { id: "chart2", type: "line", height: 220, toolbar: { autoSelected: "pan", show: !1 } },
    ...
    steplineChartColors =
        (brushchartLineColors &&
            ((optionsLine = {
                series: [{ data: data }],
                chart: { id: "chart1", height: 130, type: "area", brush: { target: "chart2", enabled: !0 }, selection: { enabled: !0, xaxis: { min: new Date("19 Jun 2017").getTime(), max: new Date("14 Aug 2017").getTime() } } },
    ...
    linechartMissingDataColors =
        (lineChartGradientColors &&
            ((options = {
                ...
                fill: { type: "gradient", gradient: { shade: "dark", gradientToColors: lineChartGradientColors, shadeIntensity: 1, type: "horizontal", opacityFrom: 1, opacityTo: 1, stops: [0, 100, 100, 100] } },
                markers: { size: 4, colors: ["#038edc"], strokeColors: "#fff", strokeWidth: 2, hover: { size: 7 } },
    ...
    lastDate =
        (linechartMissingDataColors &&
            ((options = {
                ...
                chart: { height: 350, type: "line", zoom: { enabled: !1 }, animations: { enabled: !1 } },
...
linechartrealtimeColors &&
    ((options = {
        ...
        chart: { id: "realtime", height: 350, type: "line", animations: { enabled: !0, easing: "linear", dynamicAnimation: { speed: 1e3 } }, toolbar: { show: !1 }, zoom: { enabled: !1 } },
        dataLabels: { enabled: !1 },
        stroke: { curve: "smooth" },
        title: { text: "Dynamic Updating Chart", align: "left", style: { fontWeight: 500 } },
        markers: { size: 0 },
    ...
    (charts = new ApexCharts(document.querySelector("#line_chart_realtime"), options)).render()),
    window.setInterval(function () {
        getNewSeries(lastDate, { min: 10, max: 90 }), charts.updateSeries([{ data: data }]);
    }, 1e3);
var optionsLine,
    chartLine,
    optionsLine2,
    ...
    chartSyncingLine2 =
        (chartSyncingLine &&
            ((optionsLine = {
                series: [{ data: generateDayWiseTimeSeriesline(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 60 }) }],
                chart: { id: "fb", group: "social", type: "line", height: 160, toolbar: { show: !1 } },
    ...
    chartSyncingArea =
        (chartSyncingLine2 &&
            ((optionsLine2 = {
                series: [{ data: generateDayWiseTimeSeriesline(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 30 }) }],
                chart: { id: "tw", group: "social", type: "line", height: 160, toolbar: { show: !1 } },
...
chartSyncingArea &&
    ((optionsArea = {
        series: [{ data: generateDayWiseTimeSeriesline(new Date("11 Feb 2017").getTime(), 20, { min: 10, max: 60 }) }],
        chart: { id: "yt", group: "social", type: "area", height: 160, toolbar: { show: !1 } },
